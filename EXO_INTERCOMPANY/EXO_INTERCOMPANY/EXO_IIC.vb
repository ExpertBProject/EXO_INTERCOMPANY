...
#End Region
    ...
    Private Sub cargaCampos()
        If objGlobal.refDi.comunes.esAdministrador Then
            ...
            oXML = objGlobal.funciones.leerEmbebido(Me.GetType(), "UDO_EXO_IIC.xml")
            objGlobal.refDi.comunes.LoadBDFromXML(oXML)
            objGlobal.SBOApp.StatusBar.SetText("Validado: UDO_EXO_IIC", SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Success)
        End If
    End Sub
            ...
            If infoEvento.BeforeAction = True Then
                Select Case infoEvento.MenuUID
                    Case "1281", "1282" 'Buscar y añadir
                        ...
                        If oForm.TypeEx = "UDO_FT_EXO_IIC" Then
                            Return False
                        End If
                End Select
            Else
                Select Case infoEvento.MenuUID
                    Case "EXO-MnIIC"
                        ...
                        sExiste = objGlobal.refDi.SQL.sqlStringB1("SELECT ""Code"" FROM ""@EXO_IIC"" WHERE ""Code""='" & sCode & "' ")

                        If sExiste = "" Then
                            sCode = "INTERCOMPANY"
                            sName = "Transacciones entre empresas"
                            'Presentamos UDO Y escribimos los datos de la cabecera
                            objGlobal.funcionesUI.cargaFormUdoBD("EXO_IIC")
                        Else
                            sCode = ""
                            sName = ""
                            'Presentamos la pantalla los los datos                              
                            objGlobal.funcionesUI.cargaFormUdoBD_Clave("EXO_IIC", "INTERCOMPANY")
                        End If
        ...
        Try
            ...
            If oForm.Visible = True Then
                ...
                If sCode <> "" Then
                    ...
                    oForm.DataSources.DBDataSources.Item("@EXO_IIC").SetValue("Code", 0, sCode)
                    oForm.DataSources.DBDataSources.Item("@EXO_IIC").SetValue("Name", 0, sName)
                End If
    ...
    Private Sub CargarCombos(ByRef objGlobal As EXO_UIAPI.EXO_UIAPI, ByRef oForm As SAPbouiCOM.Form)
        Dim sSQL As String = ""
        Try
            sSQL = "SELECT ""U_EXO_BBDD"" ""BBDD"", ""U_EXO_BBDD"" ""SCHEMA""  FROM ""@EXO_IPANELL"" ORDER BY ""U_EXO_BBDD"" "
            ...
            sSQL = "SELECT ""OCRD"".""CardCode"" ""CardCode"" , ""OCRD"".""CardName"" ""CardName"" FROM ""OCRD"" "
            sSQL &= " INNER JOIN ""NNM1"" ON ""NNM1"".""Series""=""OCRD"".""Series"" and ""NNM1"".""ObjectCode""='2' "
            sSQL &= " WHERE ""NNM1"".""SeriesName""='CI' and ""OCRD"".""CardType""='C' ORDER BY ""OCRD"".""CardName"" "
            ...
            sSQL = "SELECT ""OCRD"".""CardCode"" ""CardCode"" , ""OCRD"".""CardName"" ""CardName"" FROM ""OCRD"" "
            sSQL &= " INNER JOIN ""NNM1"" ON ""NNM1"".""Series""=""OCRD"".""Series"" and ""NNM1"".""ObjectCode""='2' "
            sSQL &= " WHERE ""NNM1"".""SeriesName""='PI' and ""OCRD"".""CardType""='S' ORDER BY ""OCRD"".""CardName"" "
