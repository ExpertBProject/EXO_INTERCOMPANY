Imports SAPbouiCOM
Public Class EXO_IPANEL
    Inherits EXO_UIAPI.EXO_DLLBase
#Region "Variables"
    Dim sCode As String = "" : Dim sName As String = ""
#End Region
    ...
    Private Sub cargaCampos()
        If objGlobal.refDi.comunes.esAdministrador Then
            ...
            oXML = objGlobal.funciones.leerEmbebido(Me.GetType(), "UDO_EXO_IPANEL.xml")
            objGlobal.refDi.comunes.LoadBDFromXML(oXML)
            objGlobal.SBOApp.StatusBar.SetText("Validado: UDO_EXO_IPANEL", SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Success)
        End If
    End Sub
        ...
        Try
            ...
            Else
                Select Case infoEvento.MenuUID
                    Case "EXO-MnPA"
                        sCode = "INTERCOMPANY"
                        sName = "Transacciones entre empresas"
                        'Si no existe, creamos el IC
                        sExiste = objGlobal.refDi.SQL.sqlStringB1("SELECT ""Code"" FROM ""@EXO_IPANEL"" WHERE ""Code""='" & sCode & "' ")

                        If sExiste = "" Then
                            sCode = "INTERCOMPANY"
                            sName = "Transacciones entre empresas"
                            'Presentamos UDO Y escribimos los datos de la cabecera
                            objGlobal.funcionesUI.cargaFormUdoBD("EXO_IPANEL")
                        Else
                            sCode = ""
                            sName = ""
                            'Presentamos la pantalla los los datos                              
                            objGlobal.funcionesUI.cargaFormUdoBD_Clave("EXO_IPANEL", "INTERCOMPANY")
                        End If
        ...
        Try
            ...
            If oForm.Visible = True Then
                ...
                If sCode <> "" Then
                    ...
                    oForm.DataSources.DBDataSources.Item("@EXO_IPANEL").SetValue("Code", 0, sCode)
                    oForm.DataSources.DBDataSources.Item("@EXO_IPANEL").SetValue("Name", 0, sName)
                End If
